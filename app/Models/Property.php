...
class Property extends Model
{
    ...
    protected $fillable = [
        'name','featured_image','location_id','price','sale','type','bedrooms','drawing_rooms','bathrooms','net_sqm','pool','overview','description',
    ];
    ...
    public function dynamic_pricing($lira) {
        ...
        elseif($current_currency == 'bdt'){
            ...
            if($get->successful()) {
                ...
                $bdt = number_format($bdt, 3);
                return $bdt . ' DT';
            }
        } else {
            $lira = number_format($lira, 3);
            return $lira . ' DT';
        }
    }

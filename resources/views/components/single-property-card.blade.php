<div class="{{$width}} px-2  relative rounded-md mb-6">
    <div class="shadow-lg">
        ...
        <div class="p-3">
            ...
            @endif 
            {{-- <h3 class="text-2xl py-3">{{ number_format($property->price) }} {{ __('DT') }}</h3> --}}
            ...
            <div class="border-t-2">
                <ul class="flex items-center -mx-1 my-4">
                    ...
                    <li class="px-2 py-1 bg-gray-200 rounded-md text-xs mx-1 shadow-sm">{{$property->gross_sqm}} {{ __('m') }}<sup>2</sup></li>
                </ul>
